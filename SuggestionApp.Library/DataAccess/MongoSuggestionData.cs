...
public class MongoSuggestionData : ISuggestionData
{
	...
	public async Task<List<SuggestionModel>> GettAllSuggestions()
	{
	...
	{
		var output = await GettAllSuggestions();
	...
	public async Task UpadteSuggestion(SuggestionModel suggestion)
	{
	...
	public async Task UpvoteSuggestion(string suggestionId, string userId)
	{
		...
		try
		{
			...
			var usersInTrancsaction = db.GetCollection<UserModel>(_db.UserCollectionName);
			...
			await usersInTrancsaction.ReplaceOneAsync(u => u.Id == userId, user);
